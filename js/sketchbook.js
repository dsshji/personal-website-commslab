...
loader.load( 'models/sketchbook.glb', function ( gltf ) {
    ...
    sketchbook.scale.set(0.0042, 0.0042, 0.0042);
...
canvas.addEventListener('mousemove', (e) => {
    ...
    targetRotX = 0.75 + (mouseY / height - 0.5) * 0.8;
});
...
function animate() {
    ...
    if (sketchbook) {
        sketchbook.rotation.y += (targetRotY - sketchbook.rotation.y) * 0.05;
        sketchbook.rotation.x += (targetRotX - sketchbook.rotation.x) * 0.05;
